...
var inquirerLocalConfig = [
    {
        type: 'input',
        name: 'projectName',
        message: function () { return (0, lang_1.lang)('projectName'); },
        default: function () {
    ...
    },
    {
        ...
        message: function () { return (0, lang_1.lang)('sshPrivateKeyPath'); },
        default: '~/.ssh/id_rsa'
    },
    {
        type: 'password',
        name: 'sshPassphrase',
        message: function () { return (0, lang_1.lang)('sshPassphrase'); },
    },
];
// environment
// 部署环境设置（有几种部署环境）
var inquirerDeployEnvTypesConfig = [
    {
        type: 'input',
        name: 'deployEnvTypes',
        message: function () { return (0, lang_1.lang)('deployEnvTypes') + (0, lang_1.lang)('[') + '"dev,test,prod" ' + (0, lang_1.lang)('no space') + ']'; },
        default: 'dev',
...
var inquirerProjectConfig = [
    {
        ...
        message: function () { return (0, lang_1.lang)('projectBuildScript'); },
        choices: function () {
            var choices = [];
            ...
            choices.push({ name: (0, lang_1.lang)('skip') + ' (' + (0, lang_1.lang)('skip build step') + ')', value: '' });
            choices.push({ name: (0, lang_1.lang)('custom') + ' (' + (0, lang_1.lang)('type by myself') + ')', value: '[custom]' });
            return choices;
        }
    },
    {
        ...
        message: function () { return (0, lang_1.lang)('projectBuildCustomScript'); },
...
var inquirerServerConfig = [
    {
        type: 'input',
        name: 'serverHost',
        message: function () { return (0, lang_1.lang)('serverHost'); },
    },
    {
        type: 'number',
        name: 'serverPort',
        message: function () { return (0, lang_1.lang)('serverPort'); },
        default: 22,
    ...
    },
    {
        type: 'input',
        name: 'serverUsername',
        message: function () { return (0, lang_1.lang)('serverUsername'); },
        default: 'root',
    },
    {
        type: 'password',
        name: 'serverPassword',
        message: function () { return (0, lang_1.lang)('serverPassword'); },
    },
];
...
var inquirerFileMapConfig = [
    {
        ...
        message: function () { return (0, lang_1.lang)('isSingleProjectDistPath'); },
        default: true,
    },
    {
        type: 'editor',
        name: 'fileMap',
        message: function () { return (0, lang_1.lang)('fileMap') + ' {"localPath":"serverPath"}'; },
    ...
    },
    {
        ...
        message: function () { return (0, lang_1.lang)('projectFileOrPath'); },
        default: 'dist',
        when: (function (answer) { return answer.isSingleProjectDistPath; }),
    ...
    },
    {
        ...
        message: function () { return (0, lang_1.lang)('serverDeployPath') + ' (' + (0, lang_1.lang)('Absolute path') + '. ' + (0, lang_1.lang)('At least two levels of directory') + ')'; },
        when: (function (answer) { return answer.isSingleProjectDistPath; }),
        validate: function (input) {
...
var inquirerOtherConfig = [
    {
        ...
        message: function () { return (0, lang_1.lang)('needRebuildWhenBuildScriptSameWithPreviousEnv'); },
        default: false,
    },
    {
        type: 'confirm',
        name: 'isClearServerPathBeforeDeploy',
        message: function () { return (0, lang_1.lang)('isClearServerPathBeforeDeploy'); },
        default: false,
    },
    {
        type: 'confirm',
        name: 'isClearLocalDistFileBeforeBuild',
        message: function () { return (0, lang_1.lang)('isClearLocalDistFileBeforeBuild'); },
        default: false,
    },
    {
        type: 'confirm',
        name: 'isClearLocalDistFileAfterDeploy',
        message: function () { return (0, lang_1.lang)('isClearLocalDistFileAfterDeploy'); },
        default: false,
    }
];
// -----build config[END]-----
    ...
    return __generator(this, function (_e) {
        switch (_e.label) {
            ...
            case 3:
                ...
                simpleSpinner_1.default.info(chalk_1.default.blue((0, lang_1.lang)('Environment Configuration')) + chalk_1.default.yellow(": ") + chalk_1.default.cyan(key));
                currentEnv = {
                    project: {
                        projectBuildScript: ""
                    },
