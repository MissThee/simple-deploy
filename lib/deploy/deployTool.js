    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, fs_1.promises.access(configFileFullPath, fs_1.default.constants.F_OK)];
            case 2:
                _c.sent();
                return [3 /*break*/, 4];
            case 3:
                            ...
                            for (_a = 0, _b = Object.keys(fileMapNode); _a < _b.length; _a++) {
                                ...
                                if (path_1.default.normalize(fileMapNode[key]).replace(/\\/g, '/').match(/^\/.+?\/.+?/) === null) {
                                    errorParamArr.push({
                                        ...
                                        reason: lang_1.lang('At least two levels of directories are required to use absolute paths')
                                    });
                                    isOk = false;
                                }
                            }
