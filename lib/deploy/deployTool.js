...
exports.sshDisconnect = exports.sshRenameFileByFullPath = exports.sshUnpackFile = exports.sshRemoveFile = exports.sshUploadFile = exports.sshConnect = exports.sshCheck = exports.removeFileSync = exports.removeFile = exports.buildArchive = exports.createDir = exports.mkdirsSync = exports.getRemoteArchiveFilePath = exports.getLocalArchiveFilePathByProjectPath = exports.buildCode = exports.getCorrectConfigFile = exports.confirmDeploy = exports.deployLocalTmpPath = void 0;
...
var getLocalArchiveFilePathByProjectPath = function (projectPath) {
    return path_1.default.join(process.cwd(), exports.deployLocalTmpPath, path_1.default.basename(projectPath) + '_deploy.tar.gz');
};
exports.getLocalArchiveFilePathByProjectPath = getLocalArchiveFilePathByProjectPath;
// 获取远程归档文件全路径
var getRemoteArchiveFilePath = function (projectPath, remotePath) { return __awaiter(void 0, void 0, void 0, function () {
    var localArchiveFile;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                localArchiveFile = (0, exports.getLocalArchiveFilePathByProjectPath)(projectPath);
            ...
            case 1:
                ...
                if ((_a.sent()).isFile() && !remotePath.replace(/\\/g, '/').endsWith('/')) {
                    return [2 /*return*/, path_1.default.join(remotePath.substring(0, remotePath.lastIndexOf(path_1.default.basename(remotePath))), path_1.default.basename(localArchiveFile))];
                }
                else {
                    return [2 /*return*/, path_1.default.join(remotePath, path_1.default.basename(localArchiveFile))];
                }
                return [2 /*return*/];
        }
    });
}); };
exports.getRemoteArchiveFilePath = getRemoteArchiveFilePath;
// 递归创建目录
...
// 归档
var buildArchive = function (sourcePath, outputFile) { return __awaiter(void 0, void 0, void 0, function () {
    var archive, sourcePathStat;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                sourcePath = path_1.default.join(process.cwd(), sourcePath);
                simpleSpinner_1.default.start('LOCAL Archive File', ' ', chalk_1.default.magenta(sourcePath));
                archive = (0, archiver_1.default)('tar', {
                    gzip: true,
                });
...
// 上传文件
var sshUploadFile = function (ssh, localArchiveFile, remoteFile) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                simpleSpinner_1.default.start('REMOTE Upload File', ' ', chalk_1.default.magenta(localArchiveFile));
                return [4 /*yield*/, ssh.putFile(path_1.default.normalize(localArchiveFile), path_1.default.normalize(remoteFile), null, {
                    // concurrency: 64,
                    // chunkSize:32768,
                    })];
            case 1:
...
// 解压远程文件
var sshUnpackFile = function (ssh) {
    var remoteFiles = [];
    for (var _i = 1; _i < arguments.length; _i++) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    simpleSpinner_1.default.start('REMOTE Unpack And Delete File', ' ', chalk_1.default.magenta(remoteFile));
                    if (!remoteFile.endsWith('.tar.gz')) {
                        throw (0, lang_1.lang)('not found archive file');
                    }
                    ...
                    sshCommand = "tar -zxf ".concat(remoteFile, " -C ").concat(remotePath, " && rm -f ").concat(remoteFile);
...
exports.sshUnpackFile = sshUnpackFile;
// 远程单文件改名
