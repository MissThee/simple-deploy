...
// 是否确认部署
var confirmDeploy = function (param) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                simpleSpinner_1.default.start('Create Local Tmp Dir', ' ', chalk_1.default.magenta(dirPath));
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    simpleSpinner_1.default.start('Unzip And Delete Remote File', ' ', chalk_1.default.magenta(remoteFile));
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                remoteFile = path_1.default.join(remotePath.substring(0, remotePath.lastIndexOf(path_1.default.basename(remotePath))), path_1.default.basename(projectPath));
                newName = path_1.default.basename(remotePath);
                if (!!remoteFile.endsWith(newName)) return [3 /*break*/, 3];
                return [4 /*yield*/, sshRenameFile(ssh, remoteFile, newName)];
            case 2:
                _a.sent();
                _a.label = 3;
