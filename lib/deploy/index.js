...
exports.default = (function (opts) { return __awaiter(void 0, void 0, void 0, function () {
    var scriptParamDirectly, scriptParamVerbose, envKeys, configFile, deploymentInfo, _i, envKeys_1, envKey, _a, envKeys_2, currentEnvKey, currentEnv, isFirstEnv, previousProjectBuildScript, _b, envKeys_3, currentEnvKey, currentEnv, _c, _d, fileMapKey, localZipFile, ssh, _e, _f, fileMapKey, fileMapValue, localZipFile, remoteZipFile, _g, _h, fileMapKey, fileMapValue, remoteZipFile, _j, _k, fileMapKey, fileMapValue, e_1;
    ...
    return __generator(this, function (_t) {
        switch (_t.label) {
            ...
            case 11:
                ...
                return [4 /*yield*/, deployTool.buildCode(currentEnv.project.projectBuildScript, ((_q = (_p = configFile.env[currentEnvKey]) === null || _p === void 0 ? void 0 : _p.other) === null || _q === void 0 ? void 0 : _q.verbose) === true || scriptParamVerbose)];
            case 12:
                _t.sent();
                _t.label = 13;
            case 13:
            ...
            case 21:
                ssh = _t.sent();
                if (!((_r = currentEnv.other) === null || _r === void 0 ? void 0 : _r.isClearServerPathBeforeDeploy)) return [3 /*break*/, 23];
                // 远程清理目录
            ...
            case 37:
                ...
                if (!((_s = currentEnv.other) === null || _s === void 0 ? void 0 : _s.isClearLocalDistFileAfterDeploy)) return [3 /*break*/, 39];
                // 本地清理编译后的文件
                return [4 /*yield*/, deployTool.removeFile.apply(deployTool, __spreadArray(['Dist'], Object.keys(currentEnv.fileMap), false))];
            case 38:
                // 本地清理编译后的文件
