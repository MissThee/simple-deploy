...
exports.default = (function (opts) { return __awaiter(void 0, void 0, void 0, function () {
    var directly, envKeys, configFile, deploymentInfo, _i, envKeys_1, envKey, _a, envKeys_2, currentEnvKey, currentEnv, ssh, _b, envKeys_3, currentEnvKey, currentEnv, _c, _d, fileMapKey, localZipFile, ssh, _e, _f, fileMapKey, fileMapValue, localZipFile, remoteZipFile, _g, _h, fileMapKey, fileMapValue, remoteZipFile, _j, _k, fileMapKey, fileMapValue, e_1;
    var _l, _m, _o, _p;
    return __generator(this, function (_q) {
        switch (_q.label) {
            ...
            case 8:
                ...
                _q.label = 9;
            case 9:
                if (!(_b < envKeys_3.length)) return [3 /*break*/, 38];
            ...
            case 10:
                ...
                _q.label = 11;
            case 11:
                if (!((_m = currentEnv.project) === null || _m === void 0 ? void 0 : _m.projectBuildScript)) return [3 /*break*/, 13];
            ...
            case 17:
                _c++;
                return [3 /*break*/, 14];
            case 18: return [4 /*yield*/, deployTool.sshConnect(currentEnv.server.serverHost, currentEnv.server.serverPort, currentEnv.server.serverUsername, configFile.local.sshPrivateKeyPath, configFile.local.sshPassphrase, currentEnv.server.serverPassword)
                // 远程清理目录
            ];
            case 19:
                ssh = _q.sent();
                if (!((_o = currentEnv.other) === null || _o === void 0 ? void 0 : _o.isClearServerPathBeforeDeploy)) return [3 /*break*/, 21];
            ...
            case 35:
                ...
                if (!((_p = currentEnv.other) === null || _p === void 0 ? void 0 : _p.isClearLocalDistFileAfterDeploy)) return [3 /*break*/, 37];
                return [4 /*yield*/, deployTool.removeFile.apply(deployTool, __spreadArrays(['Dist'], Object.keys(currentEnv.fileMap)))];
            case 36:
                _q.sent();
                _q.label = 37;
