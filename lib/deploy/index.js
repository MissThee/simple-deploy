    ...
    return inquirer_1.default.prompt([
        {
            type: 'confirm',
            name: 'confirm',
            message: function () { return lang_1.lang('sure to deploy') + ' ' + chalk_1.default.magenta(param.join(',')) + ' ?'; },
        }
    ]);
};
// 检查配置文件
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                simpleSpinner_1.default.start('Zip Local File', ' ', chalk_1.default.magenta(sourcePath));
...
// 删除本地文件
var removeFileTask = function (message) {
    var localPaths = [];
    for (var _i = 1; _i < arguments.length; _i++) {
        localPaths[_i - 1] = arguments[_i];
    }
    return __awaiter(void 0, void 0, void 0, function () {
        var _a, localPaths_1, localPath;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    simpleSpinner_1.default.start('Clean Local', ' ', message);
                    _a = 0, localPaths_1 = localPaths;
                    _b.label = 1;
                case 1:
                    if (!(_a < localPaths_1.length)) return [3 /*break*/, 4];
                ...
                case 3:
                    ...
                    return [3 /*break*/, 1];
                case 4:
                    simpleSpinner_1.default.succeedAppend(' ', chalk_1.default.magenta(localPaths.map(function (item) { return path_1.default.normalize(item); }).join(' , ')));
                    return [2 /*return*/];
            }
        });
    });
                ...
                return [4 /*yield*/, inquirer_1.default.prompt([
                        {
                            type: 'password',
                            name: 'password',
                            message: lang_1.lang('please input password')
                        }
                    ])];
            case 1:
                answers = _a.sent();
...
var sshUploadFileTask = function (ssh, localZipFile, remoteFile) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                simpleSpinner_1.default.start('Upload File', ' ', chalk_1.default.magenta(localZipFile));
...
var sshRemoveFileTask = function (ssh) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    simpleSpinner_1.default.start('Clean Remote File Or Path');
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    simpleSpinner_1.default.start('Unzip Remote File', ' ', chalk_1.default.magenta(remoteFile));
...
var sshRenameFileTask = function (ssh, remoteFile, newName) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                simpleSpinner_1.default.start('Rename Remote File', ' ', chalk_1.default.magenta(remoteFile));
...
exports.default = (function (env) { return __awaiter(void 0, void 0, void 0, function () {
    var configFile, _i, env_1, envKey, currentEnv, localZipFileMap, _a, _b, projectPath, outputFile, _c, _d, ssh, remoteZipFileMap, _e, _f, projectPath, localZipFile, remoteFile, remotePath, _g, _h, _j, _k, remoteZipFile, _l, _m, projectPath, remoteFile, newName, e_1;
    var _o, _p, _q;
    return __generator(this, function (_r) {
        switch (_r.label) {
            case 0: return [4 /*yield*/, confirmDeployTask(env)];
            case 1:
                // 部署确认
                if (!(_r.sent()).confirm) {
                    return [2 /*return*/];
                ...
                _r.label = 2;
            case 2:
                _r.trys.push([2, 34, , 36]);
                return [4 /*yield*/, getCorrectConfigFileTask(global_1.configFilePath, env)];
            case 3:
                configFile = _r.sent();
                if (!configFile) {
                    return [2 /*return*/];
            ...
            case 4:
                ...
                envKey = env_1[_i];
                simpleSpinner_1.default.info('Current Environment', ' ', chalk_1.default.blue.bold(envKey));
                currentEnv = configFile.env[envKey];
                if (!((_o = currentEnv.other) === null || _o === void 0 ? void 0 : _o.isClearLocalDistFileBeforeBuild)) return [3 /*break*/, 6];
                return [4 /*yield*/, removeFileTask.apply(void 0, __spreadArrays(['Dist'], Object.keys(currentEnv.fileMap)))];
            case 5:
                _r.sent();
                _r.label = 6;
            case 6: 
            ...
            case 11:
                _a++;
                return [3 /*break*/, 8];
            case 12: return [4 /*yield*/, sshConnectTask(currentEnv.server.serverHost, currentEnv.server.serverPort, currentEnv.server.serverUsername, configFile.local.sshPrivateKeyPath, configFile.local.sshPassphrase, currentEnv.server.serverPassword)
                // 清理远程目录
            ];
            case 13:
                ssh = _r.sent();
                if (!((_p = currentEnv.other) === null || _p === void 0 ? void 0 : _p.isClearServerPathBeforeDeploy)) return [3 /*break*/, 15];
            ...
            case 17:
                ...
                if ((_r.sent()).isFile() && !remotePath.replace(/\\/g, '/').endsWith('/')) {
            ...
            case 25:
                ...
                return [4 /*yield*/, fs_1.promises.stat(path_1.default.join(process.cwd(), projectPath))];
            case 26:
                if (!((_r.sent()).isFile() && !currentEnv.fileMap[projectPath].replace(/\\/g, '/').endsWith('/'))) return [3 /*break*/, 28];
                ...
                if (!!remoteFile.endsWith(newName)) return [3 /*break*/, 28];
            ...
            case 29:
                ...
                if (!((_q = currentEnv.other) === null || _q === void 0 ? void 0 : _q.isClearLocalDistFileAfterDeploy)) return [3 /*break*/, 31];
                return [4 /*yield*/, removeFileTask.apply(void 0, __spreadArrays(['Dist'], Object.keys(currentEnv.fileMap)))];
            case 30:
                _r.sent();
                _r.label = 31;
            case 31:
                _i++;
                return [3 /*break*/, 4];
            case 32: return [4 /*yield*/, removeFileTask('Tmp', deployLocalTmpPath)];
            case 33:
                _r.sent();
            ...
            case 34:
                ...
                return [4 /*yield*/, removeFileTask('Tmp', deployLocalTmpPath)];
            case 35:
                _r.sent();
