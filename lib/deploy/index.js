...
exports.default = (function (envKeys) { return __awaiter(void 0, void 0, void 0, function () {
    var configFile, deploymentInfo, _i, envKeys_1, envKey, _a, envKeys_2, currentEnvKey, currentEnv, _b, _c, fileMapKey, localZipFile, ssh, _d, _e, fileMapKey, fileMapValue, localZipFile, remoteZipFile, _f, _g, fileMapKey, fileMapValue, remoteZipFile, _h, _j, fileMapKey, fileMapValue, e_1;
    var _k, _l, _m, _o;
    return __generator(this, function (_p) {
        switch (_p.label) {
            ...
            case 3:
                ...
                _p.label = 4;
            case 4:
                if (!(_a < envKeys_2.length)) return [3 /*break*/, 33];
                ...
                if (!((_k = currentEnv.other) === null || _k === void 0 ? void 0 : _k.isClearLocalDistFileBeforeBuild)) return [3 /*break*/, 6];
                return [4 /*yield*/, deployTool.removeFile.apply(deployTool, __spreadArrays(['Dist'], Object.keys(currentEnv.fileMap)))];
            case 5:
                _p.sent();
                _p.label = 6;
            case 6:
                if (!((_l = currentEnv.project) === null || _l === void 0 ? void 0 : _l.projectBuildScript)) return [3 /*break*/, 8];
            ...
            case 12:
                _b++;
                return [3 /*break*/, 9];
            case 13: return [4 /*yield*/, deployTool.sshConnect(currentEnv.server.serverHost, currentEnv.server.serverPort, currentEnv.server.serverUsername, configFile.local.sshPrivateKeyPath, configFile.local.sshPassphrase, currentEnv.server.serverPassword)
                // 清理远程目录
            ];
            case 14:
                ssh = _p.sent();
                if (!((_m = currentEnv.other) === null || _m === void 0 ? void 0 : _m.isClearServerPathBeforeDeploy)) return [3 /*break*/, 16];
            ...
            case 30:
                ...
                if (!((_o = currentEnv.other) === null || _o === void 0 ? void 0 : _o.isClearLocalDistFileAfterDeploy)) return [3 /*break*/, 32];
                return [4 /*yield*/, deployTool.removeFile.apply(deployTool, __spreadArrays(['Dist'], Object.keys(currentEnv.fileMap)))];
            case 31:
                _p.sent();
                _p.label = 32;
