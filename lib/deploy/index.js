...
var taskList;
// 是否确认部署
var confirmDeploy = function (message) {
    return inquirer_1.default.prompt([
        {
            type: 'confirm',
            name: 'confirm',
            message: message + ', ' + lang_1.default('continue') + '?'
        }
    ]);
};
// 检查环境参数是否正确
var checkEnvParam = function (config, envKey) {
    var spinner = ora_1.default(lang_1.default('Checking')).start();
    if (envKey in config.env) {
        var currentEnv = config.env[envKey];
    }
    else {
        spinner.fail('[' + envKey + '] not exist in ' + param_1.configFilePath);
        process.exit(1);
    }
...
var buildZip = function (sourcePath, outputPath) { return __awaiter(void 0, void 0, void 0, function () {
    var spinner, basename, prePath, output, archive;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (!outputPath) {
                    ...
                    basename = path_1.default.basename(outputPath);
                    prePath = outputPath.substring(0, outputPath.indexOf(basename));
                    outputPath = path_1.default.join(prePath, 'deployTmp', basename);
                }
...
var deploy = function (param) { return __awaiter(void 0, void 0, void 0, function () {
    var configFile, _i, param_2, envKey, currentEnv, _a, _b, localPath;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 4:
                _i++;
                return [3 /*break*/, 2];
            case 5: return [4 /*yield*/, confirmDeploy()];
            case 6:
                _c.sent();
                return [2 /*return*/];
        }
